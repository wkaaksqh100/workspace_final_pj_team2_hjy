...
// import InchargeTbl from "../pages/buy/InchargeTbl";
...
// const _inchargeModalForm = { // ModalForm's 이용중인 변수 : 멤버변수처럼 이용중
// 	title: '담당자',
...
//  */
// const InchargeModalForm = ({ title, confirm, cancel } /* = props:속성 */) => {
// 	/* 이렇게 연결지어야지만, ModalForm안에서만 쓰겠다고 연결을 짓습니다. */
// 	const self = _inchargeModalForm; // this라는 이름을 쓸수 없어서, self로 지음.
...
// export { _inchargeModalForm /* ModalForm에서 사용중인 변수 */ }; // 주석처리하면, 다른곳에서 접근을 할수 없습니다.
